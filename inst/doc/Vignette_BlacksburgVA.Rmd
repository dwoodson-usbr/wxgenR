...
author: "Subhrendu Gangopadhyay, Lindsay Bearup, Andrew Verdin, Eylon Shamir, Eve Halper, David Woodson"
date: "`r Sys.Date()`"
...
Running the `wx()` weather generator code for a 10-year, 50-trace simulation on a laptop with the following characteristics results in the below run time. Parallel computing was enabled via `parallelize = T` in the wx() functoin.
